		...
		<div>
			...
			<div className="relative z-[11] pl-[15%] pr-[15%] bg-white">
				<AvailableCard img={"/src/img/image 7-lg.png"} title={title1} description={description1} subtitles={subtitles1}>
					<SessionSpeaker>
						<Speaker img={"/src/img/speaker1.png"} name={speakers[0].name} content={speakers[0].background} />
						<Speaker img={"/src/img/speaker2.png"} name={speakers[1].name} content={speakers[1].background} />
					</SessionSpeaker>
					<Social />
				</AvailableCard>
