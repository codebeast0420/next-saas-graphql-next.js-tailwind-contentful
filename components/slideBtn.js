	...
	return (
		<div className="flex mt-[50px]">
			...
			<div className="flex ml-[70%]">
				<svg width="55" height="41" viewBox="0 0 55 41" fill="none" xmlns="http://www.w3.org/2000/svg" className="prev-fact">
				...
				<svg className="ml-[10px] next-fact" width="55" height="41" viewBox="0 0 55 41" fill="none"  xmlns="http://www.w3.org/2000/svg">
